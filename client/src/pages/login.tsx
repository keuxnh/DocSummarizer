...
import { FileText, Github, Mail, Users, LogIn } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0d1117] flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">DocSum에 로그인</h1>
          <p className="text-[#8b949e]">AI 기반 문서 요약 서비스</p>
        </div>
